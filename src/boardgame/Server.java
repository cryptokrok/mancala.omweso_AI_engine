...
public class Server implements Runnable {
    ...
    public static final int DEFAULT_TIMEOUT_CUSHION = 4000;

    public static final int FIRST_MOVE_TIMEOUT = 60000;
    public static final int FIRST_MOVE_TIMEOUT_CUSHION = 10000;
