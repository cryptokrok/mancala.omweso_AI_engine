...
/** An Omweso player slow enough to lose the game. */
public class CCVerySlowPlayer extends Player {
    Random rand = new Random();

    public CCVerySlowPlayer() { super("veryslow"); }
    public CCVerySlowPlayer(String s) { super(s); }
    ...
    public Move chooseMove(BoardState bs)
    {
        ...
        if(!board_state.isInitialized()){
            ...
            try {
                Thread.sleep(Server.DEFAULT_TIMEOUT + Server.DEFAULT_TIMEOUT_CUSHION);
